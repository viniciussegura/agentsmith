...
A migration that destroys or overwrites data **MUST** be called out in the PR body (#git-pr) with the rows/columns affected and why the loss is acceptable; otherwise add a backfill first.
