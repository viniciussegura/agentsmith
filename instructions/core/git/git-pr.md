...
5. **Breaking changes** -- present whenever the title carries `!` (#git-title), omitted otherwise: one changelog-style bullet per break, naming what breaks and what a consumer does instead.
