...
3. **Verification** -- the concrete steps taken: the commands run and any test output, or, when untestable, the explicit statement #swe-done requires of an untestable change. Not a bare "it works".
