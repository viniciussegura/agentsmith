...
Deferred or out-of-scope work gets a file in the future-work directory (#swe-docs-layout), stating what it is, why it matters, and any constraints or dependencies.
Those three are the whole content, written per #code-prose.
