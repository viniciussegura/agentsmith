...
It does not displace the PR body, which is the unit's durable *execution* record (#git-pr) -- the entry carries what the unit is meant to do and its place in the sequence, the PR body what shipped and how it was verified.
