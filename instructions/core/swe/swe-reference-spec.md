...
It is the counterpart to working specs and plans (#ai-plan): those are uncommitted branch scratch, deleted when the branch ships, while the reference spec is committed, mutable, and always reflects the present.
