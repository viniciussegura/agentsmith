...
- A spec or plan is append-only history once `Approved`; corrections to the live system go to the reference spec, never back into the artifact that predates them.
